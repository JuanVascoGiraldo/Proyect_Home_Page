...
window.pageTexts.services = {
  es: {
    ...
    cards: [
      ...
      {
        title: 'Control Tower',
        subtitle: 'Visibilidad operativa',
        text: 'Monitoreo en tiempo real y visibilidad end-to-end de la cadena de suministro.'
      },
      {
        title: 'Transporte Dedicado',
        subtitle: 'Flota asignada',
        text: 'Flota asignada, trazabilidad total y cumplimiento de ventanas de entrega.'
      },
      {
        title: 'Warehousing',
    ...
    cards: [
      {
        ...
        text: 'Hazardous materials logistics powered by technology, safety protocols and trained personnel to minimize risk.'
      },
      {
        title: 'Control Tower',
        subtitle: 'Operational visibility',
        text: 'Real-time monitoring and end-to-end visibility across the entire supply chain.'
      },
      {
        title: 'Dedicated Transport',
        subtitle: 'Assigned fleet',
        text: 'Assigned fleet, full traceability and strict compliance with delivery windows.'
      },
      {
        title: 'Warehousing',
        subtitle: 'Flexible storage',
        text: 'Flexible infrastructure for inventory, picking and order preparation.'
      },
      {
        title: 'Freight Management',
        subtitle: 'Route planning',
        text: 'Route planning and operational control for high-compliance deliveries.'
      }
    ]
  }
};
